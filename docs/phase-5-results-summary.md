...
1. Add a Linux NVIDIA/NVML result from a second machine.
2. Repeat one Windows model run to estimate run-to-run variance.
3. Add result summaries to the future static Observatory.
