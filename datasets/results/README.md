...
- `nvidia-nvml`: Runs from supported Linux or Windows NVIDIA systems with NVML telemetry. These are candidates for early seed data after review.
...
- Confirm `run_environment.node_id` is a user-chosen non-sensitive machine label.
